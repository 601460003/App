<template>
  <div class="hello">
        ...
        <li v-for="goods in HotGoods" >
          <div class="shop-left" @click="shopMSG" >
            ...
            <div class="goods-goods">
              <span>{{goods.name}} <span class="goods-describe" style="color:#c8c9cc">{{goods.describe}}</span></span>
            </div>
    ...
    <div style="background:white;">
      <div style="padding: 10px;margin-top: 10px;color: rgb(85, 85, 85);border-bottom: 1px solid #F4F0EA;font-size: 15px">
        <span style="float: right;padding-top: 2px">更多 ></span>
        人气推荐
      </div>
      <div class="getChoice" v-for="hots in getChoice">
        <div style="padding: 20px">
          <img :src="hots.img" width="100px" height="100px"/>
        </div>
        <div>
          <p style="color:#333;">{{hots.name}}</p>
    ...
    <div style="background: white;padding: 0 10px">
      <div style="padding: 10px;margin-top: 10px;color: rgb(85, 85, 85);font-size: 15px">
        <span style="float: right;padding-top: 2px" @click="moremore">更多 ></span>
        专题精选
      </div>
